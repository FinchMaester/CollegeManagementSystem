$(document).ready(function () {
        // Initialize .example tables only if they exist and are not already initialized
        $('.example').each(function() {
            var $table = $(this);
            // Check if this specific table is already a DataTable
            if (!$.fn.DataTable.isDataTable($table)) {
                try {
                    ...
                    // Silently skip if initialization fails (e.g., already initialized)
                    console.log('Skipping DataTable initialization for .example table:', e);
                }
            }
        });
    });
