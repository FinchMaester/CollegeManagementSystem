                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="section_id" name="section">
                                        ...
                                        foreach ($sectionlist as $section_key => $section_value) {
                                            ?>
                                            <option value="<?php echo $section_value["id"] ?>" <?php echo set_select('section', $section_value["id"], set_value('section')); ?>><?php echo $section_value["section"] ?></option>
                                            <?php
                                        }
                                        ?>
                                    </select>
                        ...
                        <div class="table-responsive mailbox-messages overflow-visible">
                            ...
                            <table class="table table-striped table-bordered table-hover example">
                                ...
                                <tbody>
                                    <?php
                                    $i = 0;
                                    if (isset($assignteacherlist) && is_array($assignteacherlist) && !empty($assignteacherlist)) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php
                                                    // Display teacher names from the concatenated list
                                                    echo isset($teacher["teacher_names"]) ? $teacher["teacher_names"] : 'No teachers assigned';
                                                ?>
                                            </td>
                                            <td class="mailbox-date pull-right">
                                                <?php if ($this->rbac->hasPrivilege('assign_class_teacher', 'can_edit')) { ?>
                                                ...
                                                <?php } ?>
                                                <?php if ($this->rbac->hasPrivilege('assign_class_teacher', 'can_delete')) { ?>
...
<script type="text/javascript">
    $(document).ready(function () {
        var section_id_initial = '<?php echo set_value("section") ?>';
        var program_id_initial = '<?php echo set_value("program_id") ?>';
        var class_id_initial = '<?php echo set_value("class") ?>';
        ...
        // Existing feecategory_id change event (keeping as is)
