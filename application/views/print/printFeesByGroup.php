                        ...
                        <div class="row">
                            ...
                            if (!empty($feeList)) {
                                ...
                                <table class="table table-striped table-responsive" style="font-size: 8pt; border-collapse: collapse;">
                                    ...
                                    <th style="border: 1px solid #000;"><?php echo $this->lang->line('due_date'); ?></th>
                                    <th style="border: 1px solid #000;"><?php echo $this->lang->line('status'); ?></th>
                                    ...
                                    <tbody>
                                        ...
                                        if (empty($feeList)) {
                                            ...
                                            ?>
                                            <tr>
                                                <td colspan="9" class="text-danger text-center" style="border: 1px solid #000;">
    ...
    <?php
                                            ...
                                            if (is_object($fee_deposits)) {
                                                ...
                                                foreach ($fee_deposits as $fee_deposits_key => $fee_deposits_value) {
                                                    ?>
                                                    <tr class="white-td">
                                                        <td colspan="4" class="text-right" style="border: 1px solid #000;"><img src="<?php echo $this->media_storage->getImageURL('backend/images/table-arrow.png');?>" alt="" /></td>
    ...
    <?php
                                                ...
                                                if (is_object($fee_deposits)) {
                                                    ...
                                                    foreach ($fee_deposits as $fee_deposits_key => $fee_deposits_value) {
                                                        ?>
                                                        <tr class="white-td">
                                                            <td colspan="4" class="text-right" style="border: 1px solid #000;"><img src="<?php echo base_url(); ?>backend/images/table-arrow.png" alt="" /></td>
                                                            <td class="text text-center" style="border: 1px solid #000;">
                                                                <?php echo date($this->customlib->getSchoolDateFormat(), $this->customlib->dateyyyymmddTodateformat($fee_deposits_value->date)); ?>
                                                            </td>
                                                            <td class="text text-right" style="border: 1px solid #000;"><?php echo ($currency_symbol . amountFormat($fee_deposits_value->amount)); ?></td>
