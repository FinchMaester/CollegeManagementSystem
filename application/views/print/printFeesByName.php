...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="<?php echo rtrim(base_url(), '/'); ?>/backend/bootstrap/css/bootstrap.min.css">
<link rel="stylesheet" href="<?php echo rtrim(base_url(), '/'); ?>/backend/dist/css/AdminLTE.min.css">
    ...
    ?>
                    <div class="invoice">
                        <div class="row header ">
                            ...
                            <?php if (!empty($print_logo_base64)): ?>
    <img src="<?php echo $print_logo_base64; ?>" alt="School Logo" style="height: 100px; width: 100%; object-fit: contain;">
   
<?php elseif (!empty($print_logo_url)): ?>
    <img src="<?php echo $print_logo_url; ?>" alt="School Logo" style="height: 100px; width: 100%; object-fit: contain;">
<?php endif; ?>          </div>
...
if (!empty($feeList)) {
    ?>
                                ...
                                <table class="table table-striped table-responsive" style="font-size: 8pt; border: 1px solid #000;">
                                    <thead>
                                        <tr>
...
$amount    = 0;
    ...
    if (empty($feeList)) {
        ?>
                                            <tr>
                                                <td colspan="5" class="text-danger text-center" style="border: 1px solid #000;">
...
<?php endif; ?>
                            ...
                            <div class="row">
                                <?php
                                    if (!empty($feeList)) {
                                 ?>
                                    <table class="table table-striped table-responsive" style="font-size: 8pt; border-collapse: collapse;">
                                        <thead>
                                            <tr>
                                                <th style="border: 1px solid #000;"><?php echo $this->lang->line('date'); ?></th>
                                                <th style="border: 1px solid #000;"><?php echo $this->lang->line('fees_group'); ?></th>
