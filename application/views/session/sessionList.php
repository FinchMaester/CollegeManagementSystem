                        ...
                        <div class="mailbox-messages">
                            <div class="">
                                ...
                                <table class="table table-striped table-bordered table-hover example">
                                    <thead>
                                        <tr>
                                            <th><?php echo $this->lang->line('session'); ?> (BS)</th>
                                            <th><?php echo $this->lang->line('session_ad'); ?></th>
                                            <th><?php echo $this->lang->line('fiscal_year_english'); ?></th>
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($sessionlist as $session) {
                                            $session_bs = isset($session['session_bs']) ? $session['session_bs'] : $session['session'];
                                            $session_ad = isset($session['session_ad']) ? $session['session_ad'] : '';
                                            $fy_en = isset($session['fiscal_year_english']) ? $session['fiscal_year_english'] : '';
                                            $fy_np = isset($session['fiscal_year_nepali']) ? $session['fiscal_year_nepali'] : '';
                                            ?>
                                            <tr>
                                                <td class="mailbox-name">
                                                    <?php echo html_escape($session_bs); ?>
                                                    <?php if ($fy_np !== '') { ?>
                                                        <br><small class="text-muted"><?php echo html_escape($fy_np); ?></small>
                                                    <?php } ?>
                                                </td>
                                                <td class="mailbox-name"><?php echo html_escape($session_ad); ?></td>
                                                <td class="mailbox-name"><?php echo $fy_en !== '' ? html_escape($fy_en) : '<span class="text-muted">—</span>'; ?></td>
