...
foreach ($yearlist as $y_key => $year) {
    $selected = (isset($year_selected) && $year_selected == $y_key) ? 'selected' : ((isset($_POST['year']) && $_POST['year'] == $y_key) ? 'selected' : '');
    echo '<option value="' . $y_key . '" ' . $selected . '>' . $year . '</option>';
}
?>
                                        </select>
...
if (!empty($resultlist)) {
        ?>
                                    ...
                                    <div class="download_label"><?php echo $this->lang->line('staff_attendance_report'); ?></div>  <div> <?php echo
