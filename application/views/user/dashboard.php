                                ...
                                ?>
                                    <tr>	
                                        ...
                                        <td class="mailbox-name"> 
                                            <?php
                                            if ($value['issue_date'] != '') {
                                                $bsd = $this->customlib->formatLibraryDateBsForDisplay($value['issue_date']);
                                                echo $bsd !== '' ? htmlspecialchars($bsd) : '';
                                            }
                                            ?>
                                        </td> 
                                        <td >
                                            ...
                                            if ($value['duereturn_date'] != '') {
                                                $bsd = $this->customlib->formatLibraryDateBsForDisplay($value['duereturn_date']);
                                                echo $bsd !== '' ? htmlspecialchars($bsd) : '';
                                            }
                                            ?> 
