            ...
            <div class="">
                <ul class="reportlists">
                    ...
                    if ($this->rbac->hasPrivilege('student_report', 'can_view')) {
                        ?>
                        <li class="col-lg-4 col-md-4 col-sm-6 <?php echo set_SubSubmenu('Reports/student_information/student_registration_report'); ?>">
                            <a href="<?php echo base_url(); ?>report/studentregistrationreport">
                                <i class="fa fa-file-text-o"></i> <?php echo $this->lang->line('student_registration_report'); ?>
                            </a>
                        </li>
...
<?php } ?>
                       ...
                       <?php if ($this->rbac->hasPrivilege('graduation_report', 'can_view')) { ?>
                       <li class="col-lg-4 col-md-4 col-sm-6 <?php echo set_SubSubmenu('Reports/student_information/graduation_report'); ?>">
                       <a href="<?php echo base_url(); ?>report/graduation_report">
                       <i class="fa fa-file-text-o"></i><?php echo $this->lang->line('graduation_report'); ?>
                    </a>
                   </li>
               <?php } ?>


               <?php if ($this->rbac->hasPrivilege('dropout_report', 'can_view')) { ?>
                       <li class="col-lg-4 col-md-4 col-sm-6 <?php echo set_SubSubmenu('Reports/student_information/dropout_report'); ?>">
                       <a href="<?php echo base_url(); ?>report/dropout_report">
                       <i class="fa fa-file-text-o"></i><?php echo $this->lang->line('dropout_report'); ?>
                    </a>
                   </li>
               <?php } ?>


               <?php if ($this->rbac->hasPrivilege('student_counts', 'can_view')) { ?>
                       <li class="col-lg-4 col-md-4 col-sm-6 <?php echo set_SubSubmenu('Reports/student_information/student_counts'); ?>">
                       <a href="<?php echo base_url(); ?>report/student_counts">
                       <i class="fa fa-file-text-o"></i> HEMIS Report
                    </a>
                   </li>
               <?php } ?>
