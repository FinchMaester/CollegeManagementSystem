                    ...
                    <div class="">
                        ...
                        <div class="box-body table-responsive">
                            ...
                            <table class="table table-striped table-bordered table-hover example">
                                ...
                                <tbody>
                                    ...
                                    foreach ($result as $key => $value) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo !empty($value['program_title']) ? $value['program_title'] : 'N/A'; ?></td>
                                ...
                                <?php if(!empty($result)){ ?>
                                    <tr><td> </td><td> </td><td><b><?php echo $total_boys; ?></b></td><td><b><?php echo $total_girls; ?></b></td><td><b><?php echo $total_students; ?></b></td><td><b><?php echo $all_boys_girls_ratio; ?></b></td></tr>
                                <?php } ?>
                            </table>
                        </div>
                    </div>
