                ...
                <div class="box removeboxmius">
                    ...
                    <form role="form" action="<?php echo site_url('report/getbookissueparameter') ?>" method="post" class="" id="reportform">
                        <div class="box-body row"  >
                            ...
                            <?php $this->load->view('reports/_library_academic_filters'); ?>
                            <div class="col-sm-6 col-md-6">
                                <div class="form-group">
                    ...
                    <div class="">
                        ...
                        <div class="box-header ptbnull">
                            <h3 class="box-title titlefix"><i class="fa fa-money"></i> <?php echo $this->lang->line('book_due_report'); ?></h3>
                        </div>
                        <div class="box-body table-responsive">
                            <div class="download_label"><?php echo $this->lang->line('book_due_report').' '.$this->customlib->get_postmessage();
                                            ?> </div>

                             <table class="table table-striped table-bordered table-hover record-list" data-export-title="<?php echo $this->lang->line('book_due_report').' '.$this->customlib->get_postmessage();
                                            ?> ">
                                <thead>
                                    <tr>
