<!-- Modified view file to include program data -->
                        ...
                        <table class="table table-striped table-bordered table-hover example">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text text-center"><?php echo $this->lang->line('program'); ?></th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text text-center">
                                        <?php 
                                        // Fixed: Use program_name instead of program
                                        echo !empty($class_section_value->program_name) ? $class_section_value->program_name : 'N/A'; 
                                        ?>
                                    </td>
                                    <td class="text text-center"><?php echo $class_section_value->student_count; ?></td>
                                    <td class="text text-right">    
                                        <button type="button" class="btn btn-default btn-xs studentlist" id="load" data-toggle="tooltip" 
                                            data-clssection-id="<?php echo $class_section_value->id; ?>" 
                                            data-program-id="<?php echo !empty($class_section_value->program_id) ? $class_section_value->program_id : ''; ?>"
                                            title="<?php echo $this->lang->line('view_students'); ?>" 
...
$(document).on('click', '.programstudentlist', function () {
    var $this = $(this);
    
    $.ajax({
        type: 'POST',
        url: baseurl + "student/getStudentByProgram",
        data: {'program_id': $this.data('programId')},
        dataType: 'JSON',
        beforeSend: function () {
            $this.button('loading');
        },
