...
if ($examgroup->description == "") {
        ...
        if ($this->rbac->hasPrivilege('exam_group', 'can_edit')) {
            ?>
                                                        <a href="<?php echo site_url('admin/examgroup/assignsubjectgroups/' . $examgroup->id); ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('assign_subject_groups'); ?>">
