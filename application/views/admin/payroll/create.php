...
foreach ($monthAttendance as $attendence_key => $attendence_value) {
    // Convert AD date to BS month
    $ad_timestamp = strtotime($attendence_key);
    $ad_month = (int)date('n', $ad_timestamp);
    $ad_year = (int)date('Y', $ad_timestamp);
    
    // Convert AD month to BS month (BS starts in mid-April)
    $bs_month = $ad_month;
    if ($ad_month >= 4) {
    ...
    // Get BS month name
    $bs_month_name = isset($nepali_months[$bs_month]) ? $nepali_months[$bs_month] : date("F", $ad_timestamp);
    ?><tr>
                                                    <td><?php echo $bs_month_name; ?></td>
                                                    ...
                                                    <td><?php echo $monthLeaves[date("m", $ad_timestamp)]; ?></td>
                                                </tr>
                                                <?php
}
?>
...
?>" id="basic"  type="text" />
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8 net_green">
                                                    ...
                                                    <input class="form-control" name="redirect_role" value="<?php echo isset($redirect_role) ? $redirect_role : ''; ?>"  type="hidden" />
                                                </div>
                                            </div><!--./form-group-->
                                        </div>
                                    </div>
