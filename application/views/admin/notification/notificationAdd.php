                                  ...
                                  <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input id="date" name="date"  placeholder="" type="text" class="form-control nepali-datepicker"  value="<?php echo set_value('date'); ?>" />
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input id="publish_date" name="publish_date"  placeholder="" type="text" class="form-control nepali-datepicker"  value="<?php echo set_value('publish_date'); ?>" />
