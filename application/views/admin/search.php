...
$(document).ready(function() {
     ...
     if(search_text && search_text != "" && search_text != "0"){
        search_text = search_text.trim();
     } else {
        search_text = "";
     }
     
     // Always initialize DataTable, with or without search text
     var params = {search_text: search_text};
     initDatatable_page('header-student-list','admin/admin/dtstudentlist', params, [], 10);
});
