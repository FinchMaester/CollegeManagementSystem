...
foreach ($classlist as $class) {
    ?>
                                        <option <?php echo set_select('old_class_id', $class['id']); ?> value="<?php echo $class['id'] ?>"><?php echo $class['class'] . ' - ' . $class['degree'] ?></option>
                                            <?php
}
?>
                                </select>
...
if (isset($value['topic'])) {
     ...
     <span><?php echo $losson_count . "." . $topic_count; ?></span>
                <label class="checkbox-inline">
      <input type="checkbox" value="<?php echo $topic_value['id']; ?>" name="topic_id[]">    <?php echo $topic_value['name']; ?>
    </label>
                </li>
    ...
    function getsubjectBySubjectGroup(class_id, section_id, subject_group_id, subject_group_subject_id, subject_target,session_id=null) {
        if (class_id != "" && section_id != "" && subject_group_id != "") {
            ...
            $.ajax({
                ...
                data: {'subject_group_id': subject_group_id,"session_id":session_id},
                dataType: 'JSON',
                beforeSend: function () {
                    // setting a timeout
