            ...
            <div class="col-md-4">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"><?php echo $this->lang->line('edit_topic'); ?></h3>
                    </div>
...
if ($class_id == $class["id"]) {
    ...
    ?> value="<?php echo $class['id'] ?>"><?php echo $class['class'] . ' - ' . $class['degree'] ?></option>
                                            <?php
}
?>
                                </select>
                            ...
                            <?php foreach ($edittopicname as $edittopicname_value) {?>
                                <div class="form-group" id="<?php echo $edittopicname_value['id']; ?>"><label><?php echo $this->lang->line("topic_name"); ?></label><small class="req"> *</small><input type="text" name="topic_<?php echo $edittopicname_value['id']; ?>" value="<?php echo $edittopicname_value['name']; ?>" style="width:95%" /><?php if ($this->rbac->hasPrivilege('topic', 'can_delete')) {?><span  onclick="remove_topic('<?php echo $edittopicname_value['id']; ?>')" class="section_id_error text-danger">&nbsp;<i class="fa fa-remove"></i></span> <?php }?></div>
                            <?php }?>
            ...
            <div class="col-md-8">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <div class="table-responsive mailbox-messages overflow-visible" id="transfee">
...
<script>
    ...
    function add_topic() {
        var id = makeid(8);
        $('#topic_result').append('<div class="form-group" id="' + id + '"><label><?php echo $this->lang->line("topic_name"); ?></label><small class="req"> *</small><input type="text" name="topic[]" style="width:95%" /><span  onclick="remove_topic(' + id + ')" class="section_id_error text-danger">&nbsp;<i class="fa fa-remove"></i></span></div>');
    }
