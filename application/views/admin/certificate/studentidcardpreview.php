 ...
 <table cellpadding="0" cellspacing="0" width="100%" style="background: <?php echo $idcard->header_color; ?>;">
      <tr>
                            <td valign="top">
                                ...
                                <img src="<?php echo $this->media_storage->getImageURL('uploads/student_id_card/background/'.$idcard->background); ?>" class="tcmybg" style="opacity: .1"/></td>
                        </tr>
    <tr>
...
if ($idcard->enable_section == 1) {
        echo "<li>" . $this->lang->line('section') . "<span>A</span></li>";
    }
    ?>
     <?php
if ($idcard->enable_program == 1) {
        echo "<li>" . $this->lang->line('program') . "<span>BBA</span></li>";
    }
    ?>
                                            <?php
...
if ($idcard->enable_blood_group == 1) {
    ...
    ?>
                        ...
                        <div class="signature">
                            <img src="<?php echo $this->media_storage->getImageURL('uploads/student_id_card/signature/' . $idcard->sign_image); ?>" width="200" height="24" /></div>
                        <?php if ($idcard->enable_student_barcode == 1) {?>
                                <?php if (file_exists("./uploads/staff_id_card/barcodes/default.png")) {?>
                                <div class="signature">
                                    <img src="<?php echo $this->media_storage->getImageURL('uploads/staff_id_card/barcodes/default.png'); ?>" width="80" height="24"/></div>
                        <?php }}?>
    ...
    ?>
                        ...
                        <tr>
                            <td valign="top" align="right" class="principal">
                                <img src="<?php echo $this->media_storage->getImageURL('uploads/student_id_card/signature/'.$idcard->sign_image); ?>" width="66" height="40" /></td>
                        </tr>
                    </table>
                </td>
            </tr>
