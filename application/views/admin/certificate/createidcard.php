                        ...
                        <form id="form1" enctype="multipart/form-data" action="<?php echo site_url('admin/studentidcard/create') ?>"  id="certificateform" name="certificateform" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                ...
                                <div class="form-group switch-inline">
                                    ...
                                    <div class="material-switch switchcheck">
                                        <input id="enable_section" name="is_active_section" type="checkbox" class="chk" value="1" <?php echo set_checkbox('is_active_section', '1', (set_value('is_active_section') == 1) ? TRUE : FALSE); ?>>
                                ...
                                <div class="form-group switch-inline">
                                    ...
                                    <div class="material-switch switchcheck">
                                        <input id="enable_program" name="is_active_program" type="checkbox" class="chk" value="1" <?php echo set_checkbox('is_active_program', '1', (set_value('is_active_program') == 1) ? TRUE : FALSE); ?>>
