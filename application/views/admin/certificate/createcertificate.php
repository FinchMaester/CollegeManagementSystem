...
if (isset($error_message)) {
    ...
    ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="certificate_text" name="certificate_text"  rows="3" placeholder="This is to certify that Mr/Miss/Ms. &lt;b&gt;[name]&lt;/b&gt; son/daughter of Mr. &lt;b&gt;[father_name]&lt;/b&gt; and Ms. &lt;b&gt;[mother_name]&lt;/b&gt; a permanent inhabitant of District. &lt;b&gt;[current_address]&lt;/b&gt; was a bonafide student of this campus and passed &lt;b&gt;[class]&lt;/b&gt; level with &lt;b&gt;[section]&lt;/b&gt; division in the year &lt;b&gt;[admission_date]&lt;/b&gt;. Symbol No: [symbol_no], Registration No: [registration_no], Roll No: [roll_no]. He/She had fine demeanour and took part in most of the co-curricular and extracurricular activities of the campus. He/She bore a good moral character while at campus. I wish him/her bright future."></textarea>
                                    <span class="text-primary">[name] [dob] [present_address] [guardian] [created_at] [admission_no] [roll_no] [symbol_no] [registration_no] [class] [section] [gender] [admission_date] [category] [cast] [father_name] [mother_name] [religion] [email] [phone]
                                        <?php
