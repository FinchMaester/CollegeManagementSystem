                                        ...
                                        <div class="staround">
                                            ...
                                            <div class="cardright">
                                                <ul class="stlist">
                                                    ...
                                                    ?>
                                                    <?php
                                                    if ($idcardlist[0]->enable_section == 1) {
                                                        echo "<li>" . $this->lang->line('section') . "<span>" . $list[0]['section'] . "</span></li>";

                                                    }
                                                    ?>
                                                     <?php
                                                    if ($idcardlist[0]->enable_program == 1) {
                                                        echo "<li>" . $this->lang->line('program') . "<span>" . $list[0]['program'] . "</span></li>";
                                                    }
                                                    ?>
                                                     <?php
                                                    if ($idcardlist[0]->enable_class == 1) {
                                                        echo "<li>" . $this->lang->line('class') . "<span>" . $list[0]['class']  . "</span></li>";
                                                    }
                                                    ?>
                                                    <?php
