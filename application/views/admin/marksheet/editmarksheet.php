...
if (isset($error_message)) {
    ...
    ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="marksheet_edit_date_field" name="date" placeholder="" type="text" class="form-control" data-skip-global-init="true" value="<?php echo set_value('date', $marksheet->date); ?>"/>
        ...
        ?>
                                ...
                                <div class="form-group switch-inline">
                                    ...
                                    <div class="material-switch switchcheck">
                                        <input id="is_program" name="is_program" type="checkbox" class="chk" value="1" <?php echo set_checkbox('is_program', '1', (set_value('is_program', $marksheet->is_program) == 1) ? true : false); ?>>
...
(function() {
    ...
    $.fn.nepaliDatePicker = function(options) {
        ...
        if (this.is('#marksheet_edit_date_field')) {
...
$(document).ready(function() {
    console.log('Marksheet edit page script loaded');
    
    // Initialize ONLY Nepali datepicker on our specific field
    setTimeout(function() {
        var $field = $('#marksheet_edit_date_field');
        ...
        if ($.fn.nepaliDatePicker && !$field.data('nepali-initialized')) {
            ...
            console.log('Nepali datepicker initialized on marksheet edit field');
