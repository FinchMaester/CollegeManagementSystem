    ...
    ?>
                <div class="col-md-4">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title"><?php echo $this->lang->line('add_marksheet'); ?></h3>
                        </div><!-- /.box-header -->
        ...
        $this->session->unset_userdata('msg'); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="marksheet_date_field" name="date" value="<?php echo set_value('date'); ?>" placeholder="" type="text" class="form-control" data-skip-global-init="true" />
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="documents" name="background_img" placeholder="" type="file" class="filestyle form-control" data-height="40" >
                                ...
                                <div class="form-group switch-inline">
                                  ...
                                  <div class="form-group switch-inline">
                                    ...
                                    <div class="material-switch switchcheck">
                                        <input id="is_rank" name="is_rank" type="checkbox" class="chk" value="1">
                                ...
                                <div class="form-group switch-inline">
                                    ...
                                    <div class="material-switch switchcheck">
                                        <input id="is_program" name="is_program" type="checkbox" class="chk" value="1">
                                        <label for="is_program" class="label-success"></label>
                                    </div>
                                </div>
                                <div class="form-group switch-inline">
                                ...
                                <?php
                                $marksheet = null;
                                $this->load->view('admin/marksheet/marksheet_column_designer');
                                $this->load->view('admin/marksheet/marksheet_student_detail_designer');
                                $this->load->view('admin/marksheet/marksheet_footer_designer');
                                ?>
                            </div><!-- /.box-body -->
...
<script type="text/javascript">
// CRITICAL: This must run BEFORE the global initializers
(function() {
    var originalNepaliDP = $.fn.nepaliDatePicker;
    var originalBootstrapDP = $.fn.datepicker;
    
    // Intercept the global initializer
    $.fn.nepaliDatePicker = function(options) {
        // Only allow if called directly on our field
        if (this.is('#marksheet_date_field')) {
            return originalNepaliDP.call(this, options);
        }
        // Block for all other selectors on this page
        return this;
    };
    
    $.fn.datepicker = function(options) {
        // Block English datepicker completely on this page
        if (this.is('#marksheet_date_field')) {
            return this; // Do nothing
        }
        return originalBootstrapDP.call(this, options);
    };
})();

$(document).ready(function() {
    console.log('Marksheet page script loaded');
    
    // Initialize ONLY Nepali datepicker on our specific field
    setTimeout(function() {
        var $field = $('#marksheet_date_field');
        
        if ($.fn.nepaliDatePicker && !$field.data('nepali-initialized')) {
            // Restore original function temporarily
            var temp = $.fn.nepaliDatePicker;
            $.fn.nepaliDatePicker = $.fn.nepaliDatePicker.original || temp;
            ...
            $field.data('nepali-initialized', true);
            console.log('Nepali datepicker initialized on marksheet field');
            
            // Restore interceptor
            $.fn.nepaliDatePicker = temp;
        }
    }, 100);
});
</script>