...
?>
                                ...
                                <div class="form-group col-md-4 col-sm-4">
                                    ...
                                    <input id="issue_date" name="issue_date" placeholder="" type="text" class="form-control nepali-datepicker"  value="<?php echo set_value('issue_date'); ?>" readonly />
                                ...
                                <div class="form-group col-md-4 col-sm-4">
                                    ...
                                    <input id="return_date" name="return_date" placeholder="" type="text" class="form-control nepali-datepicker"  value="<?php echo set_value('return_date'); ?>" readonly/>
