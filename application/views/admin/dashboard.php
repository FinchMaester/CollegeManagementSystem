<script>
    console.log("Chart library status:", typeof Chart !== 'undefined' ? "Loaded" : "Not loaded");
</script>
    ...
    <section class="content">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12">
                <div class="box box-primary borderwhite">
                    <div class="box-header with-border">
                        <h3 class="box-title">Student Enrollment Status by Academic Session</h3>
                    ...
                    <div class="box-body">
                        <div id="d3-enrollment-chart" style="height: 400px;"></div>
                    </div>
                </div>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-12">
                    ...
                    <div class="box-header with-border">
                        ...
                        <div class="box-tools pull-right">
                            <span class="badge badge-primary">
                                <?php echo isset($ratio_data['ratio']) ? $ratio_data['ratio'] : '0'; ?>:1
                            </span>
                        </div>
                    </div>
                    <div class="box-body">
                        <canvas id="ratioChart" height="360px;"></canvas>
                    </div>
                    <div class="card-footer">
                        <small>Total Students: <?php echo isset($ratio_data['total_students']) ? $ratio_data['total_students'] : '0'; ?></small><br>
                        <small>Total Teachers: <?php echo isset($ratio_data['total_teachers']) ? $ratio_data['total_teachers'] : '0'; ?></small>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">Student Gender Distribution by Program</h3>
                    <div class="box-tools pull-right">
                        <button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
                        <button class="btn btn-box-tool" data-widget="remove"><i class="fa fa-times"></i></button>
                    </div>
                ...
                <div class="box-body">
                    <div class="chart">
                        <canvas id="genderProgramChart" style="height: 450px;"></canvas>
                    </div>
                </div>
            </div>
        </div>
            ...
            if (($this->module_lib->hasActive('fees_collection')) || ($this->module_lib->hasActive('expense'))) {
                if ($this->rbac->hasPrivilege('fees_collection_and_expense_monthly_chart', 'can_view')) {
                    ...
                    <div class="col-lg-7 col-md-7 col-sm-12 col60">
                        <div class="box box-primary borderwhite">
                            <div class="box-header with-border">
                                <h3 class="box-title"><?php echo $this->lang->line('fees_collection_expenses_for'); ?>         <span class="bs-month-year-display"><?php echo $this->lang->line(strtolower(date('F'))) . " " . date('Y'); ?></span></h3>
                ...
                if ($this->rbac->hasPrivilege('income_donut_graph', 'can_view')) {
                    ...
                    <div class="col-lg-5 col-md-5 col-sm-12 col40">
                        <div class="box box-primary borderwhite">
                            <div class="box-header with-border">
                                <h3 class="box-title">
                                    <?php echo $this->lang->line('income') . " - "; ?><span class="bs-month-year-display"><?php echo $this->lang->line(strtolower(date('F'))) . " " . date('Y'); ?></span>
                                </h3>
                            </div>
                            <div class="box-body">
                ...
                if ($this->rbac->hasPrivilege('fees_collection_and_expense_yearly_chart', 'can_view')) {
                    ...
                    <div class="col-lg-7 col-md-7 col-sm-12 col60">
                        <div class="box box-info borderwhite">
                            <div class="box-header with-border">
                                <h3 class="box-title"><?php echo $this->lang->line('fees_collection_expenses_for_session'); ?>
                ...
                <?php if ($this->rbac->hasPrivilege('expense_donut_graph', 'can_view')) {
                    ...
                    <div class="col-lg-5 col-md-5 col-sm-12 col40">
                        <div class="box box-primary borderwhite">
                            <div class="box-header with-border">
                                <h3 class="box-title">
                                    <?php echo $this->lang->line('expense') . " - "; ?><span class="bs-month-year-display"><?php echo $this->lang->line(strtolower(date('F'))) . " " . date('Y'); ?></span>
                                </h3>
                            </div><!--./info-box-->
                            <div class="box-body">
                                <div class="chart-responsive">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="topprograssstart">
                            ...
                            <p class="text-uppercase mt10 clearfix"><?php echo $book_overview['dueforreturn']; ?>
                                <?php echo $this->lang->line('due_for_return'); ?><span class="pull-right"></span>
                            </p>
                            <div class="progress-group">
                                <div class="progress progress-minibar">
            ...
            <div class="row">
                <div class="col-lg-9 col-md-9 col-sm-12 col80">
                    <div class="row">
                                    ...
                                    <div class="info-box">
                                        <a href="<?php echo site_url('studentfee') ?>">
                                            ...
                                            <div class="info-box-content">
                                                ...
                                                <span
                                                    class="info-box-number"><?php if ($month_collection) {
                                    ...
                                    <div class="info-box">
                                        <a href="<?php echo site_url('admin/expense') ?>">
                                            ...
                                            <div class="info-box-content">
                                                ...
                                                <span
                                                    class="info-box-number"><?php if ($month_expense) {
                        ...
                        <?php } ?>
                        <?php if ($this->rbac->hasPrivilege('faculty_count_widget', 'can_view')) { ?>
                            <div class="col-md-4 col-sm-6">
                                <div class="info-box">
                                    <a href="<?php echo site_url('sections') ?>">
                                        <span class="info-box-icon bg-green"><i class="fa fa-user-md"></i></span>
                                        <div class="info-box-content">
                                            <span class="info-box-text"><?php echo $this->lang->line('faculty'); ?></span>
                                            <span class="info-box-number"><?php echo $total_faculty; ?></span>
                                        </div>
                                    </a>
                                </div>
                            </div>
                        ...
                        <?php if ($this->rbac->hasPrivilege('programs_count_widget', 'can_view')) { ?>
                            <div class="col-md-4 col-sm-6">
                                <div class="info-box">
                                    <a href="<?php echo site_url('programs') ?>">
                                        <span class="info-box-icon bg-yellow"><i class="fa fa-graduation-cap"></i></span>
                                        <div class="info-box-content">
                                            <span class="info-box-text"><?php echo $this->lang->line('programs'); ?></span>
                                            <span class="info-box-number"><?php echo $total_programs; ?></span>
                                        </div>
                                    </a>
                                </div>
                            </div>
                        ...
                        <?php if ($this->rbac->hasPrivilege('graduates_count_widget', 'can_view')) { ?>
                            <div class="col-md-4 col-sm-6">
                                <div class="info-box">
                                    <a href="<?php echo site_url('student/graduates') ?>">
                                        <span class="info-box-icon bg-blue"><i class="fa fa-mortar-board"></i></span>
                                        <div class="info-box-content">
                                            <span class="info-box-text"><?php echo $this->lang->line('graduates'); ?></span>
                                            <span class="info-box-number"><?php echo $total_graduates; ?></span>
                                        </div>
                                    </a>
                                </div>
                            </div>
                        ...
                        <?php if ($this->rbac->hasPrivilege('dropouts_count_widget', 'can_view')) { ?>
                            <div class="col-md-4 col-sm-6">
                                <div class="info-box">
                                    <a href="<?php echo site_url('student/dropouts') ?>">
                                        <span class="info-box-icon bg-red"><i class="fa fa-user-times"></i></span>
                                        <div class="info-box-content">
                                            <span class="info-box-text"><?php echo $this->lang->line('dropouts'); ?></span>
                                            <span class="info-box-number"><?php echo $total_dropouts; ?></span>
                                        </div>
                                    </a>
                                </div>
                            </div>
                        ...
                        <?php if ($this->rbac->hasPrivilege('gender_count_widget', 'can_view')) { ?>
                            <div class="col-md-4 col-sm-6">
                                <div class="info-box">
                                    <a href="<?php echo site_url('student/male') ?>">
                                        <span class="info-box-icon bg-purple"><i class="fa fa-male"></i></span>
                                        <div class="info-box-content">
                                            <span class="info-box-text"><?php echo $this->lang->line('male'); ?></span>
                        ...
                        <?php if ($this->rbac->hasPrivilege('gender_count_widget', 'can_view')) { ?>
                            <div class="col-md-4 col-sm-6">
                                <div class="info-box">
                                    <a href="<?php echo site_url('student/female') ?>">
                                        <span class="info-box-icon bg-pink"><i class="fa fa-female"></i></span>
                                        <div class="info-box-content">
                                            <span class="info-box-text"><?php echo $this->lang->line('female'); ?></span>
                        ...
                        <?php if ($this->rbac->hasPrivilege('staff_count_widget', 'can_view')) { ?>
                            <div class="col-md-4 col-sm-6">
                                <div class="info-box">
                                    <a href="<?php echo site_url('admin/staff') ?>">
                                        <span class="info-box-icon bg-teal"><i class="fa fa-users"></i></span>
                                        <div class="info-box-content">
                                            <span class="info-box-text"><?php echo $this->lang->line('total_staff'); ?></span>
                ...
                if ($this->rbac->hasPrivilege('staff_role_count_widget', 'can_view')) {
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-12 col20">
                        <?php foreach ($designations as $designation => $count) {
                            ?>
                            <div class="info-box">
                                <a href="#">
                                <span class="info-box-icon bg-yellow"><i class="fa fa-user-secret"></i></span>
                                    <div class="info-box-content">
                                        <span class="info-box-text"><?php echo $designation; ?></span>
...
<script>
$(document).ready(function() {
    createD3EnrollmentChart();
    
    function createD3EnrollmentChart() {
        var data = [];
        
        <?php
        if (!empty($enrollment_status_data) && is_array($enrollment_status_data)) {
            foreach ($enrollment_status_data as $edata) {
                $session_label = isset($edata['session']) ? $edata['session'] : (isset($edata['year']) ? $edata['year'] : '');
                ?>
            data.push({
                session: <?php echo json_encode((string) $session_label); ?>,
                enrolled: <?php echo (int) (isset($edata['enrolled']) ? $edata['enrolled'] : 0); ?>,
                graduated: <?php echo (int) (isset($edata['graduated']) ? $edata['graduated'] : 0); ?>,
                dropout: <?php echo (int) (isset($edata['dropout']) ? $edata['dropout'] : 0); ?>
            });
                <?php
            }
        }
        ...
        var container = document.getElementById('d3-enrollment-chart');
        var margin = {top: 30, right: 20, bottom: 90, left: 50},
            width = Math.max(220, container.clientWidth - margin.left - margin.right),
            height = Math.max(180, container.clientHeight - margin.top - margin.bottom);

        var svg = d3.select("#d3-enrollment-chart")
            .append("svg")
        ...
        var x1 = d3.scaleBand()
            .domain(['enrolled', 'graduated', 'dropout'])
            .rangeRound([0, x0.bandwidth()])
            .padding(0.05);
        
        var maxValue = d3.max(data, function(d) {
            return Math.max(d.enrolled, d.graduated, d.dropout);
        }) || 0;
        ...
        var sessionGroup = svg.selectAll(".session-group")
            .data(data)
            .enter().append("g")
            .attr("class", "session-group")
            .attr("transform", function(d) { return "translate(" + x0(d.session) + ",0)"; });
        
        var categories = ['enrolled', 'graduated', 'dropout'];
        var categoryLabels = {
        ...
        categories.forEach(function(category) {
            sessionGroup.append("rect")
                ...
                .attr("x", function(d) { return x1(category); })
                .attr("y", function(d) { return y(d[category]); })
                .attr("width", x1.bandwidth())
                .attr("height", function(d) { return Math.max(0, height - y(d[category])); })
                .attr("fill", color(category))
                .on("mouseover", function(event, d) {
                    var value = d[category];
                    d3.select(this).attr("opacity", 0.8);
                    tooltip.transition().duration(200).style("opacity", .9);
                    tooltip.html(categoryLabels[category] + " (" + d.session + "): <strong>" + value + "</strong>")
        ...
        var legend = svg.append("g")
            .attr("class", "legend")
            .attr("transform", "translate(" + Math.max(0, width - 190) + ",0)");
        ...
        function updateChart() {
            var newWidth = Math.max(220, container.clientWidth - margin.left - margin.right);
            x0.rangeRound([0, newWidth]);
            x1.rangeRound([0, x0.bandwidth()]);
            d3.select("#d3-enrollment-chart svg")
...
<script>
// Use Chart.js 2.x (already loaded above) — avoid loading Chart.js 3+ which breaks other dashboard charts.
(function () {
    var ratioEl = document.getElementById('ratioChart');
    if (ratioEl && typeof Chart !== 'undefined') {
        new Chart(ratioEl.getContext('2d'), {
            type: 'pie',
            data: {
                ...
                datasets: [{
                    label: 'Count',
                    data: [
                        <?php echo isset($ratio_data['total_students']) ? (int) $ratio_data['total_students'] : 0; ?>,
                        <?php echo isset($ratio_data['total_teachers']) ? (int) $ratio_data['total_teachers'] : 0; ?>
                    ],
    ...
    var programEl = document.getElementById('genderProgramChart');
    if (!programEl || typeof Chart === 'undefined') {
        return;
    }
    ...
    <?php
    if (!empty($gender_program_data) && is_array($gender_program_data)) {
        foreach ($gender_program_data as $program) {
            ?>
    programLabels.push(<?php echo json_encode(isset($program['full_program_name']) ? $program['full_program_name'] : 'Unassigned'); ?>);
    maleData.push(<?php echo isset($program['male_count']) ? (int) $program['male_count'] : 0; ?>);
    femaleData.push(<?php echo isset($program['female_count']) ? (int) $program['female_count'] : 0; ?>);
            <?php
        }
    }
    ?>
    ...
    new Chart(programEl.getContext('2d'), {
        type: 'bar',
        data: {
            ...
            tooltips: {
                ...
                callbacks: {
                    ...
                    label: function (tooltipItem, data) {
                        ...
                        return ds.label + ': ' + Number(tooltipItem.yLabel).toLocaleString();
                    }
                }
            },
            scales: {
                xAxes: [{
                    ticks: {
                        ...
                        callback: function (value) {
                            ...
                            return value.length > 28 ? value.substring(0, 26) + '…' : value;
                        }
                    }
                }],
                yAxes: [{
...
// Convert English month/year to Nepali BS month/year in dashboard
$(document).ready(function() {
    try {
        if (window.NepaliFunctions && typeof NepaliFunctions.AD2BS === 'function') {
            var today = new Date();
            ...
            if (bs && bs.year && bs.month) {
                ...
                var bsMonthName = nepaliMonths[bs.month] || '';
                var bsYear = bs.year;
                var bsDisplay = bsMonthName + ' ' + bsYear;
                
                // Update all month/year displays
                $('.bs-month-year-display').each(function() {
                    $(this).text(bsDisplay);
                });
            }
        }
    } catch(e) {
        console.warn('Could not convert dashboard dates to BS:', e);
    }
});
</script>