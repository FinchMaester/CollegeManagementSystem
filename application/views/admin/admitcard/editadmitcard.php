...
if (isset($error_message)) {
    ...
    ?>
                                ...
                                <div class="material-switch switchcheck">
                                    <input id="is_program" name="is_program" type="checkbox" class="chk" value="1" <?php echo set_checkbox('is_program', '1', (set_value('is_program', $admitcard->is_program) == 1) ? true : false); ?>>
