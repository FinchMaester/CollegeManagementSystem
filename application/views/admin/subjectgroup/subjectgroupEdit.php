...
foreach ($subjectlist as $subject) {
    if (isset($subject['is_academic']) && $subject['is_academic'] == '1') { // Academic
        ...
        <div class="checkbox">
            <label>
                <input type="checkbox" name="subject[]" value="<?php echo $subject['id'] ?>" <?php echo set_checkbox('subject[]', $subject['id'], (isset($subjectgroup[0]->group_subject) && is_array($subjectgroup[0]->group_subject) && in_array($subject['id'], array_column($subjectgroup[0]->group_subject, 'subject_id'))) ? true : false); ?> ><?php echo $subject['name'] ?>
            </label>
        </div>
        <?php
    }
