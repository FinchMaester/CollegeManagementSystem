...
/** Map cumulative GPA (4.0 scale) to letter — used before PDF body (functions at file end run too late). */
if (!function_exists('exam_pdf_gpa_to_letter')) {
    function exam_pdf_gpa_to_letter($p) {
        $p = (float) $p;
        if ($p >= 3.61) return 'A+';
        if ($p >= 3.21) return 'A';
        if ($p >= 2.81) return 'B+';
...
$student_value=$marksheet['student'];
                    ...
                    <?php
                     ...
                     <?php
                                                          if ($template->is_roll_no) {
                                                            ...
                                                            ?>
                                 <td style="text-transform: uppercase;text-align: center;"  width="50%"><?php echo   $roll_no=($exam->use_exam_roll_no) ? $student_value['exam_roll_no']:$student_value['student_roll_no']; ?></td>
              <?php
                                                          }
                                                        ?>                        
                    </tr>
                    <tr>
                        ...
                        Certificated That</td>
                         ...
                         <td valign="top" align="right" style="border: 1px solid #000000; width: 120px;padding:2px;">
     <?php
                            ...
                            <td valign="top">
                                <table cellpadding="0" cellspacing="0" width="100%">
                                    ...
                                    if ($template->is_class && $template->is_section) {
                                        ...
                                        ?>
                                        <tr>
                                            <td valign="top" style="text-transform: uppercase; padding-bottom: 15px;"><?php echo $this->lang->line('class'); ?> &nbsp;&nbsp;&nbsp;<span style="font-weight: bold;" class="span"><?php echo $student_value['class_id']; ?> </span></td>
                                        </tr>
                                        <?php
                                    ...
                                    if ($template->exam_center != "") {
                                        ?>
                                         ...
                                         <tr>
                                            <td valign="top" style="text-transform: uppercase; padding-bottom: 15px;"> <?php echo $this->lang->line('exam_center'); ?> &nbsp;&nbsp;&nbsp;<span style="font-weight: bold;" class="span"><?php echo $template->exam_center; ?></span></td>
                                        </tr>                                    
                                        <?php
                                    }
                                    ?>
            ...
            <td valign="top">
             ...
             <tr>
                   ...
                   <?php
                                            ...
                                            $has_ng_subject = false;
                                            
                                            foreach ($marksheet['result'] as $exam_result_key => $exam_result_value) {
                                                $total_max_marks = $total_max_marks + $exam_result_value->max_marks;
                                                $subj_absent = (strtolower($exam_result_value->attendence ?? '') == 'absent');
                                                if ($subj_absent) $absent_status = true;
                                                if (!$subj_absent) $total_obtain_marks = $total_obtain_marks + $exam_result_value->get_marks;
                                                ?>
                                                 <tr>
                                                    <td>
                                                    ...
                                                    if ($exam->exam_group_type != "gpa") {
                                                        ...
                                                        <td>
                                                            ...
                                                            if ($subj_absent) {
                                                                ...
                                                                $percentage_grade = ($exam_result_value->max_marks > 0) ? (($exam_result_value->get_marks * 100) / $exam_result_value->max_marks) : 0;
                                                                $point = findGradePoints($exam_grades, $percentage_grade);
                                                                $total_points = $total_points + $point;
                                                                $grade_letter = findGrade($exam_grades, $percentage_grade);
                                                                if (strtoupper($grade_letter) === 'NG') $has_ng_subject = true;
                                                                echo $point;
                                                            }
                                                            ?>
                                                        </td>
                                            ...
                                            if ($exam->exam_group_type != "gpa") {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php
                                                        if ($total_hours <= 0 || $absent_status || $has_ng_subject) {
                                                            echo '-';
                                                        } else {
                                                            $total_grade_percentage = ($total_max_marks > 0) ? (($total_obtain_marks * 100) / $total_max_marks) : 0;
                                                            $gpa_float = (float) $total_quality_point / (float) $total_hours;
                                                            $exam_qulity_point = number_format($gpa_float, 2, '.', '');
                                                            $percentage_total = ($exam_qulity_point * 100) / 10;
                                                            echo $total_quality_point . "/" . $total_hours . "=" . $exam_qulity_point . " [" . exam_pdf_gpa_to_letter($gpa_float) . "]";
                                                        }
                                                        ?>
                                                    </td>
                                                    <td valign="top" style="text-align: left;border-right:1px solid #999"></td>
...
?>
            ...
            <td valign="top">
                <table cellpadding="0" cellspacing="0" width="100%" class="">
                    <tr>
                        <td valign="top">
                              <table cellpadding="0" cellspacing="0" width="98%" class="denifittable marks">                <tr>
                       <?php 
                                                        if ($template->is_admission_no) { 
                                                            ?>
                        <th valign="top" style="text-align: center; text-transform: uppercase;" ><?php echo $this->lang->line('admission_no') ?></th>
                                                            <?php
                                                        }
                                                        ?>                    
                      <?php 
                           ...
                           if ($template->is_roll_no) {
                                                            ?>
                        <th valign="top" style="text-align: center; text-transform: uppercase; "><?php echo $this->lang->line('roll_number') ?></th>
                                                            <?php
                                                            }  ?>
                    </tr>
                    <tr>
                    <?php
                     ...
                     <?php
                                                          if ($template->is_roll_no) {
                                                            ...
                                                            ?>
                                 <td style="text-transform: uppercase;text-align: center;"><?php echo  $roll_no=($exam->use_exam_roll_no)? $marksheet['exam_result']['exam_roll_no_' . $exam->id]:$student_value['student_roll_no'];; ?></td>
              <?php
                                                          }
                                                        ?>
...
if(!empty($marksheet['exam_result']['exam_result_' . $exam->id])){
    ...
    <tbody>
             <tr>
                                                ...
                                                if ($exam->exam_group_type != "gpa") {
                                                    ...
                                                    <th><?php echo $this->lang->line('grade') . " " . $this->lang->line('point'); ?></th>
                                                    <th><?php echo $this->lang->line('credit_hours'); ?></th>
                                                    <th><?php echo $this->lang->line('quality') . " " . $this->lang->line('point') ?></th>
                                                    <?php
                                                }
                   ...
                   <?php
                                            ...
                                            $result_status = 1;
                                            $absent_status = false;
                                            $has_ng_subject_conn = false;
                                            $percentage_total=0;

            foreach ($marksheet['exam_result']['exam_result_' . $exam->id] as $exam_result_key => $exam_result_value) {
                                                $total_max_marks = $total_max_marks + $exam_result_value->max_marks;
                                                $subj_absent_conn = (strtolower($exam_result_value->attendence ?? '') == 'absent');
                                                if ($subj_absent_conn) $absent_status = true;
                                                if (!$subj_absent_conn) $total_obtain_marks = $total_obtain_marks + $exam_result_value->get_marks;
                                                ?>
                                                 <tr>
                                                    <td>
                                                        <?php echo $exam_result_value->name ; ?> <?php if($exam_result_value->code){ echo ' ('.$exam_result_value->code.')'; } ?>
                                                    ...
                                                    if ($exam->exam_group_type != "gpa") {
                                                        ...
                                                        <td>
                                                            ...
                                                            if ($subj_absent_conn) {
                                                                ...
                                                                $point = findGradePoints($exam_grades, $percentage_grade);
                                                                $total_points = $total_points + $point;
                                                                if (strtoupper(findGrade($exam_grades, $percentage_grade)) === 'NG') $has_ng_subject_conn = true;
                                                                echo $point;
                                                            }
                                                            ?>
                                                        </td>
                                            ...
                                            if ($exam->exam_group_type != "gpa") {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php
                                                        if ($total_hours <= 0 || $absent_status || $has_ng_subject_conn) {
                                                            echo '-';
                                                        } else {
                                                            $total_grade_percentage = ($total_max_marks > 0) ? (($total_obtain_marks * 100) / $total_max_marks) : 0;
                                                            $gpa_float = (float) $total_quality_point / (float) $total_hours;
            ...
            <td valign="top" style="padding-top: 10px;">
                <table cellpadding="0" cellspacing="0" width="100%%" class="">
                    <tr>
                      <td valign="top" width="30%"> <?php echo $this->lang->line('division') ?></td>
                        <td valign="top" style="font-weight: bold;">
                              <?php echo findExamDivision( $marks_division, $percentage_total);    ?>
                        </td>
                    </tr>
                </table>
            </td>
...
echo ($student_value['rank']);                                
 ...
 <tr>
                            <td valign="top" style="padding-top: 10px;">
                                <?php
                                if (!empty($marksheet['exam_result'])) {
                                    ...
                                    $consolidate_get_exam_total_percentage=0;

                                    foreach ($marksheet['exams'] as $each_exam_key => $each_exam_value) {

                                        if (empty($marksheet['exam_result']['exam_result_' . $each_exam_value->id])) {
                                            $is_consoledate = 0;
                                        }
                                    }
                                     ?>                            
                                             ...
                                             <tr>
                                                ...
                                                foreach ($marksheet['exams'] as $each_exam_key => $each_exam_value) {
                                                    if ($is_consoledate) {
                                                        ...
                                                        <td>
     <?php
          $return_consolidate = examTotalResult($marksheet['exam_result']['exam_result_' . $each_exam_value->id],$exam->exam_group_type,$exam_grades);

          $consolidate_exam_data = json_decode($return_consolidate);
             $exam_status=$consolidate_exam_data->exam_result;  
     
if($exam->exam_group_type != "gpa"){

        if (!$consolidate_exam_data->exam_result) {
            $consolidate_exam_status = false;
        }

        $percentage_grade = (($consolidate_exam_data->get_marks * 100) / $consolidate_exam_data->max_marks);
        $consolidate_marks_exam_total +=  $consolidate_exam_data->max_marks;

        $weightage_marks = getWeightageExam($marksheet['exam_connection_list'], $each_exam_value->id, $consolidate_exam_data->get_marks, $percentage_grade);
    ...
    if($each_exam_value->exam_group_type == "average_passing"){
         ...
         $consolidate_exam_result = ($consolidate_exam_data->quality_point / $consolidate_exam_data->credit_hours);
         $consolidate_marks_exam_total +=  $consolidate_exam_data->max_marks;
