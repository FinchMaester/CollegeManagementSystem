                ...
                <div class="row">
                    <form role="form" id="addleave_form" method="post" enctype="multipart/form-data" action="">
                        <div class="form-group  col-xs-12 col-sm-12 col-md-12 col-lg-6">
                            ...
                            <input type="text" id="applieddate" name="applieddate" value="" class="form-control nepali-datepicker" readonly="readonly">
                        </div>
                        <div class="form-group  col-xs-12 col-sm-12 col-md-12 col-lg-6 ">
                            <label>
...
?>
                        ...
                        <div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-6">
                            <label><?php echo $this->lang->line('leave_from_date'); ?></label><small class="req"> *</small>
                                <input type="text" readonly id="leave_from_date" name="leave_from_date" class="form-control nepali-datepicker" >
                            <!-- /.input group -->
                        </div>
                         <div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-6">
                            <label><?php echo $this->lang->line('leave_to_date'); ?></label><small class="req"> *</small>
                                <input type="text" readonly id="leave_to_date" name="leave_to_date" class="form-control nepali-datepicker" >
                            <!-- /.input group -->
                        </div>
...
<script type="text/javascript">
    ...
    function addLeave() {
        ...
        var currentNepaliDate = new Date().toISOString().substr(0, 10);
        $('input[type=text][name=applieddate]').val(''); 
    ...
    function getRecord(id) {
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                // Display Nepali dates directly without conversion
                ...
                // Display Nepali applied date directly
    ...
    $(document).ready(function (e) {
        $("#addleave_form").on('submit', (function (e) {
            ...
            $.ajax({
                ...
                complete: function() {
                   // Reset button is handled in success/error callbacks
                }
              });
        }));
    });
    ...
    function editRecord(id) {
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                $('input[name="applieddate"]').val(result.date); // Use Nepali date directly
                $('input[name="filename"]').val(result.document_file);
                $('#leave_from_date').val(result.leave_from); // Use Nepali date directly
                $('#leave_to_date').val(result.leave_to); // Use Nepali date directly
...
<script type="text/javascript">
$(document).ready(function() {
    $('#applieddate').nepaliDatePicker({
        dateFormat: '%Y-%m-%d',
        ndpMonth: true,
        ndpYear: true,
        readOnlyInput: true
    });
    $('#leave_from_date').nepaliDatePicker({
        dateFormat: '%Y-%m-%d',
        ndpMonth: true,
        ndpYear: true,
        readOnlyInput: true
    });
    $('#leave_to_date').nepaliDatePicker({
        dateFormat: '%Y-%m-%d',
        ndpMonth: true,
        ndpYear: true,
        readOnlyInput: true
