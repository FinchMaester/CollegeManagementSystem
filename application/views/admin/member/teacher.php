...
<button  data-stdid="<?php echo $teacher['id'] ?>" data-employee-id="<?php echo $teacher['employee_id']; ?>" class="btn btn-default btn-xs add-teacher"  data-toggle="tooltip" title="<?php echo $this->lang->line('add'); ?>" >
...
<script type="text/javascript">
    ...
    $(".add-teacher").click(function () {
        ...
        // Pre-fill library card number with employee ID (which is globally unique)
        $('#library_card_no').val(employeeId);
