                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="due_date" name="due_date" placeholder="" type="text" class="form-control nepali-datepicker"  value="<?php echo set_value('due_date', $this->customlib->dateformat($feegroup_type->due_date)); ?>" readonly="readonly" />
