...
// Get current session and convert to BS using Customlib function
$currentSession = $this->setting_model->getCurrentSessionName();
// Check if session is already in BS format (starts with 20xx where xx > 57, e.g., 2081, 2138)
$parts = explode('-', $currentSession);
$isAlreadyBS = false;
if (count($parts) == 2) {
    $year1 = intval($parts[0]);
    // If year is >= 2080, it's likely already in BS format
    if ($year1 >= 2080) {
        $isAlreadyBS = true;
    }
}
// Only convert if not already in BS format
$bsSession = $isAlreadyBS ? $currentSession : $this->customlib->convertSessionToBS($currentSession);
?>
                ...
                <div class="col-md-4">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title"><?php echo $this->lang->line('add_fees_master') . " : " . $bsSession; ?></h3>
                        </div><!-- /.box-header -->
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="due_date" name="due_date" placeholder="" type="text" class="form-control nepali-datepicker"  value="<?php echo set_value('due_date'); ?>" readonly="readonly" />
            ...
            ?>">
                ...
                <div class="box box-primary">
                    <div class="box-header ptbnull">
                        <h3 class="box-title titlefix"><?php echo $this->lang->line('fees_master_list') . " : " . $bsSession; ?></h3>
                    </div><!-- /.box-header -->
                    <div class="box-body">
                        <div class="download_label"><?php echo $this->lang->line('fees_master_list') . " : " . $bsSession; ?></div>
