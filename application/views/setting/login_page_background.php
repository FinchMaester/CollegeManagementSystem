                                ...
                                <h4><?php echo $this->lang->line('admin_penal'); ?></h4> 
                                    <div class="text-center">    
                                        <div class="card-h-hidden">
                                            <?php
                                            if (empty($result->admin_login_page_background)) {
                                                ?>
                                                <div class="card-body-logo-img"><img src="<?php echo base_url('uploads/school_content/login_image/images.png'); ?>" class="" alt="Admin Login Background" width="304" height="236" onerror="this.src='<?php echo base_url('backend/images/docsicon.png'); ?>'"></div>
                                                <?php
                                            } else {
                                                ?>
                                                <div class="card-body-logo-img"><img src="<?php echo base_url('uploads/school_content/login_image/' . $result->admin_login_page_background); ?>" class="" alt="Admin Login Background" width="304" height="236" onerror="this.src='<?php echo base_url('backend/images/docsicon.png'); ?>'"></div>
                                                <?php
                                            }
                                            ?>
                                        </div>    
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6">
                                ...
                                <h4> <?php echo $this->lang->line('user_penal'); ?></h4> 
                                    <div class="text-center">     
                                        <div class="card-h-hidden">
                                            <?php
                                            if (empty($result->user_login_page_background)) {
                                                ?>
                                                <div class="card-body-logo-img"><img src="<?php echo base_url('uploads/school_content/login_image/images.png'); ?>" class="" alt="User Login Background" width="304" height="236" onerror="this.src='<?php echo base_url('backend/images/docsicon.png'); ?>'"></div>
                                                <?php
                                            } else {
                                                ?>
                                                <div class="card-body-logo-img"><img src="<?php echo base_url('uploads/school_content/login_image/' . $result->user_login_page_background); ?>" class="" alt="User Login Background" width="304" height="236" onerror="this.src='<?php echo base_url('backend/images/docsicon.png'); ?>'"></div>
                                                <?php
                                            }
                                            ?>
                                        </div>    
