                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="col-lg-3 col-md-6 col-sm-6">
                                ...
                                <h4> <?php echo $this->lang->line('print_logo'); ?></h 4> 
                                    <div class="text-center">     
                                        <?php
                                        $print_logo_file = !empty($result->image) ? $result->image : '';
                                        
                                        if (!empty($print_logo_file)) {
                                            $print_logo_url = base_url('uploads/school_content/logo/' . rawurlencode($print_logo_file)) . img_time();
                                        } else {
                                            $print_logo_url = $this->media_storage->getImageURL('uploads/school_content/logo/images.png');
                                        }
                                        ?>
                                        <div class="card-body-logo-img">
                                            <img src="<?php echo $print_logo_url; ?>" class="" alt="" width="304" height="236" id="print_logo_img" onerror="this.onerror=null; this.src='<?php echo base_url('uploads/school_content/logo/images.png'); ?>'">
                                        </div>
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6">
                                <div class="card-body-logo">
                                    ...
                                    <div class="text-center"> 
                                        <?php
                                        $admin_logo_file = !empty($result->admin_logo) ? $result->admin_logo : '';
                                        
                                        if (!empty($admin_logo_file)) {
                                            $admin_logo_url = base_url('uploads/school_content/admin_logo/' . rawurlencode($admin_logo_file)) . img_time();
                                        } else {
                                            $admin_logo_url = $this->media_storage->getImageURL('uploads/school_content/admin_logo/images.png');
                                        }
                                        ?>
                                        <div class="card-body-logo-img">
                                            <img src="<?php echo $admin_logo_url; ?>" class="" alt="" width="204" height="60" id="admin_logo_img" onerror="this.onerror=null; this.src='<?php echo base_url('uploads/school_content/admin_logo/images.png'); ?>'">
                                        </div>
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6">
                                ...
                                <h4><?php echo $this->lang->line('admin_small_logo'); ?></h4>   
                                    <div class="text-center"> 
                                        <?php
                                        $admin_small_logo_file = !empty($result->admin_small_logo) ? $result->admin_small_logo : '';
                                        
                                        if (!empty($admin_small_logo_file)) {
                                            $admin_small_logo_url = base_url('uploads/school_content/admin_small_logo/' . rawurlencode($admin_small_logo_file)) . img_time();
                                        } else {
                                            $admin_small_logo_url = $this->media_storage->getImageURL('uploads/school_content/logo/images.png');
                                        }
                                        ?>
                                        <img src="<?php echo $admin_small_logo_url; ?>" width="32" height="32" id="admin_small_logo_img" alt="" onerror="this.onerror=null; this.src='<?php echo base_url('uploads/school_content/logo/images.png'); ?>'">
                             ...
                             <div class="col-lg-3 col-md-6 col-sm-6">
                                ...
                                <h4><?php echo $this->lang->line('app_logo'); ?> </h4> 
                                    <div class="text-center">    
                                        <?php
                                        $app_logo_file = !empty($result->app_logo) ? $result->app_logo : '';
                                        
                                        if (!empty($app_logo_file)) {
                                            $app_logo_url = base_url('uploads/school_content/logo/app_logo/' . rawurlencode($app_logo_file)) . img_time();
                                        } else {
                                            $app_logo_url = $this->media_storage->getImageURL('uploads/school_content/logo/images.png');
                                        }
                                        ?>
                                        <div class="card-body-logo-img">
                                            <img src="<?php echo $app_logo_url; ?>" width="290" height="51" id="app_logo_img" class="" alt="" onerror="this.onerror=null; this.src='<?php echo base_url('uploads/school_content/logo/images.png'); ?>'">
                                        </div>
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (response.success) {
                    successMsg(response.message);
                    // Close modal first
                    $('#modal-upload_admin_small_logo').modal('hide');
                    // Reload page to show updated logo
                    setTimeout(function() {
                        window.location.reload(true);
                    }, 500);
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (response.success) {
                    successMsg(response.message);
                    // Close modal first
                    $('#modal-upload_admin_logo').modal('hide');
                    // Reload page to show updated logo
                    setTimeout(function() {
                        window.location.reload(true);
                    }, 500);
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (response.success) {
                    successMsg(response.message);
                    // Close modal first
                    $('#modal-upload_app_logo').modal('hide');
                    // Reload page to show updated logo
                    setTimeout(function() {
                        window.location.reload(true);
                    }, 500);
