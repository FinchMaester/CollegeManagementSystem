<div class="col-md-2">
    <div class="box border0">
        <ul class="tablists">
            ...
            <li class="<?php echo set_SubSubmenu('hemisintegration/index'); ?>">
                <a class="<?php echo set_SubSubmenu('hemisintegration/index'); ?>" href="<?php echo site_url('hemisintegration') ?>"><?php echo $this->lang->line('hemis_integration'); ?></a>
            </li>
            <li class="<?php echo set_SubSubmenu('admin/data_sanitization/index'); ?>">
                <a class="<?php echo set_SubSubmenu('admin/data_sanitization/index'); ?>" href="<?php echo site_url('admin/data_sanitization'); ?>">Database Sanitization</a>
            </li>
            <li class="<?php echo set_SubSubmenu('admin/ugc_error_log/index'); ?>">
                <a class="<?php echo set_SubSubmenu('admin/ugc_error_log/index'); ?>" href="<?php echo site_url('admin/ugc_error_log'); ?>">UGC Error Log</a>
            </li>
            <li class="<?php echo set_SubSubmenu('admin/rbac_debug/index'); ?>">
                <a class="<?php echo set_SubSubmenu('admin/rbac_debug/index'); ?>" href="<?php echo site_url('admin/rbac_debug'); ?>">RBAC Debug</a>
            </li>
            <li class="<?php echo set_SubSubmenu('admin/hemis_qa/index'); ?>">
                <a class="<?php echo set_SubSubmenu('admin/hemis_qa/index'); ?>" href="<?php echo site_url('admin/hemis_qa'); ?>">HEMIS Infrastructure (QA)</a>
            </li>
            <?php } ?>
        </ul>
    </div>
