...
<div class="content-wrapper">
    <section class="content-header">
        <h1><i class="fa fa-money"></i> <?php //echo $this->lang->line('fees_collection'); ?> <small> <?php //echo $this->lang->line('filter_by_name1'); ?></small></h1>
    </section>
    <!-- Main content -->
                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                   ...
                                   <input id="date_from" name="date_from" placeholder="" type="text" class="form-control nepali-datepicker" value="<?php echo set_value('date_from') ?>" autocomplete="off" readonly="readonly">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input id="date_to" name="date_to" placeholder="" type="text" class="form-control nepali-datepicker" value="<?php echo set_value('date_to') ?>" autocomplete="off" readonly="readonly">
...
foreach ($fees_data as $fee_key => $fee_value) {
 ...
 ?>
<tr>
    <td><?php echo htmlspecialchars($fee_key); ?></td>
