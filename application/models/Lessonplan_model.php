...
class Lessonplan_model extends MY_model
{
    ...
    public function add_copy_lesson($lesson_array,$topic_array)
    {
        ...
        $topic_array['lesson_id']=$insert_id;
         $this->db->insert('topic', $topic_array);
        //======================Code End==============================
 ...
 public function gettopicByID($id)
    ...
    public function getsubject_group_class_sectionsId($class_id, $section_id, $subject_group_id, $program_id = null, $session_id = null)
    {
        $session_id = IsNullOrEmptyString($session_id) ? $this->current_session : $session_id;
    
        $this->db->select('subject_groups.name, subject_group_class_sections.*');
        ...
        $this->db->where('subject_groups.id', $subject_group_id);
        $this->db->where('subject_groups.session_id', $session_id);
        
        // Add program_id condition if provided
        if (!empty($program_id)) {
