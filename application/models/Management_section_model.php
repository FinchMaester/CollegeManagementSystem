...
/** Non-teaching sections — api_management_sections. PDF §5.6 (paths use Managent typo for Section). */
class Management_section_model extends CI_Model
{
    protected $table = 'api_management_sections';
    ...
    protected function _map_to_row(array $data, $partial = false)
    {
        ...
        if (array_key_exists('sectionName', $data)) {
            $row['section_name'] = $data['sectionName'];
        }
