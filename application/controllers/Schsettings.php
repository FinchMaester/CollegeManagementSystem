...
class Schsettings extends Admin_Controller
{
    ...
    public function index()
    {
        ...
        if(isset($data['result']->province) && !empty($data['result']->province)) {
            $data['districts'] = $this->district_model->getByProvinceId($data['result']->province);
        } else {
            $data['districts'] = array();
        }

        if(isset($data['result']->district) && !empty($data['result']->district)) {
            $data['municipalities'] = $this->municipality_model->getByDistrictId($data['result']->district);
        } else {
    ...
    public function generalsetting()
    {
        ...
        $this->form_validation->set_rules('level_of_study', $this->lang->line('level_of_study'), 'trim|required|xss_clean');
        $this->form_validation->set_rules('affiliated_university', 'Affiliating University', 'trim|required|xss_clean');


        $this->form_validation->set_rules('province', $this->lang->line('province'), 'trim|required|xss_clean');
        $this->form_validation->set_rules('district', $this->lang->line('district'), 'trim|required|xss_clean');
        $this->form_validation->set_rules('local_level', $this->lang->line('local_level'), 'trim|required|xss_clean');
        $this->form_validation->set_rules('ward', $this->lang->line('ward'), 'trim|required|xss_clean');
        ...
        $this->form_validation->set_rules('campus_chief_name', 'Campus Chief Name', 'trim|xss_clean');
        $this->form_validation->set_rules('campus_chief_contact', 'Campus Chief Contact', 'trim|xss_clean');
        $this->form_validation->set_rules('campus_chief_email', 'Campus Chief Email', 'trim|valid_email|xss_clean');
        $this->form_validation->set_rules('campus_it_name', 'Campus IT Name', 'trim|xss_clean');
        $this->form_validation->set_rules('campus_it_contact', 'Campus IT Contact', 'trim|xss_clean');
        $this->form_validation->set_rules('campus_it_email', 'Campus IT Email', 'trim|valid_email|xss_clean');
        ...
        if ($this->form_validation->run() == false) {
            $data = array(
                ...
                'local_level' => form_error('local_level'),
                'ward' => form_error('ward'),
                'level_of_study' => form_error('level_of_study'),
                'affiliated_university' => form_error('affiliated_university'),
                'latitude' => form_error('latitude'),
                'longitude' => form_error('longitude'),
                'campus_chief_name' => form_error('campus_chief_name'),
                'campus_chief_contact' => form_error('campus_chief_contact'),
                'campus_chief_email' => form_error('campus_chief_email'),
                'campus_it_name' => form_error('campus_it_name'),
                'campus_it_contact' => form_error('campus_it_contact'),
                'campus_it_email' => form_error('campus_it_email'),
            ...
            $data = array(
                ...
                'affiliated_university' => $this->input->post('affiliated_university'),
                'level_of_study' => $this->input->post('level_of_study'),
                'latitude' => $this->input->post('latitude'),
                'longitude' => $this->input->post('longitude'),
                'campus_chief_name' => $this->input->post('campus_chief_name'),
                'campus_chief_contact' => $this->input->post('campus_chief_contact'),
                'campus_chief_email' => $this->input->post('campus_chief_email'),
                'campus_it_name' => $this->input->post('campus_it_name'),
                'campus_it_contact' => $this->input->post('campus_it_contact'),
                'campus_it_email' => $this->input->post('campus_it_email'),
            );
    ...
    public function savebackendtheme()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            // Properly update the session theme
            if ($this->session->has_userdata('admin')) {
                $admin = $this->session->userdata('admin');
                $admin['theme'] = $this->input->post('theme');
