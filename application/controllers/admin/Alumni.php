...
class Alumni extends Admin_Controller
{
        ...
        if ($this->input->server('REQUEST_METHOD') == "GET") {
            ...
            if (isset($search)) {
                if ($search == 'search_filter') {
                    // Alumni are already passed out — pass-out session is the primary filter.
                    // Faculty / program / class (last enrolled level) are optional refinements.
                    ...
                    if ($this->form_validation->run() == false) {
                        ...
                        $resultlist          = $this->student_model->search_alumniStudent($class, $section, $session_id, $program);
    ...
    public function add_event()
    {
        ...
        $event_starting_date = $this->input->post('from_date');
        $event_end_date = $this->input->post('to_date');
