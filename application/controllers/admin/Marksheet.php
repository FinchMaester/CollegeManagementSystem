...
class Marksheet extends Admin_Controller
{
    ...
    public function index()
    {
        ...
        $this->data['default_column_json'] = json_encode(marksheet_layout_default_columns());
        ...
        if ($this->form_validation->run() == true) {
            ...
            $insert_data = array(
                ...
                'middle_sign'       => "",
                'background_img'    => "",
                'column_layout_json' => $this->input->post('column_layout_json'),
                'marksheet_display_mode' => $this->input->post('marksheet_display_mode') ? $this->input->post('marksheet_display_mode') : 'legacy',
                'grading_system_mode' => $this->input->post('grading_system_mode') ? $this->input->post('grading_system_mode') : 'inherit',
                'marksheet_show_grading_details' => $this->input->post('marksheet_show_grading_details') ? 1 : 0,
                'marksheet_show_attendance_block' => $this->input->post('marksheet_show_attendance_block') ? 1 : 0,
                'marksheet_show_nonacademic_block' => $this->input->post('marksheet_show_nonacademic_block') ? 1 : 0,
                'student_detail_layout_json' => $this->input->post('student_detail_layout_json'),
                'marksheet_footer_json'      => $this->input->post('marksheet_footer_json'),
            );
