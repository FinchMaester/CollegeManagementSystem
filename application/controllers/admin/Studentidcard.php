...
class studentidcard extends Admin_Controller
{
    ...
    public function create()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $studentname     = 0;
            $class           = 0;
            $section         = 0;  // Added section
            $program         = 0;  // Added program
            $fathername      = 0;
            $mothername      = 0;
            $address         = 0;
            $phone           = 0;
            ...
            if ($this->input->post('is_active_section') == 1) {
                $section = $this->input->post('is_active_section');
            }
            // Added program handling
            if ($this->input->post('is_active_program') == 1) {
                $program = $this->input->post('is_active_program');
            }
            ...
            $data = array(
                ...
                'enable_class'           => $class,
                'enable_section'         => $section,    // Added section
                'enable_program'         => $program,    // Added program
